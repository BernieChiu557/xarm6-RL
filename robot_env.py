...
try:
    ...
    from gymnasium_robotics.utils import mujoco_py_utils, rotations
...
try:
    ...
    from gymnasium_robotics.utils import mujoco_utils, rotations
except ImportError as e:
...
class BaseRobotEnv(GoalEnv):
    ...
    def step(self, action):
        ...
        # print(obs["achieved_goal"].shape, obs["desired_goal"].shape)
    ...
    def reset(
        ...
        *,
        ...
        if (self.goal.shape[0] > 100 and self.goal.shape[1] != 10):
